...
//
// O botão de escanear QR NÃO mora mais aqui como badge fixo flutuante —
// agora vive inline no header do cardápio (MenuHeader/TableMenuHeader),
// ao lado do nome do restaurante, por pedido explícito de design.
